...
#include "Hotel_Outbreak_ComplainRoomDirty.generated.h"

UCLASS()
class BOOTS_ANKLE_HOTEL_API UHotel_Outbreak_ComplainRoomDirty : public UHotel_OutbreakEventBase
{
	GENERATED_BODY()

public:
	UHotel_Outbreak_ComplainRoomDirty();
