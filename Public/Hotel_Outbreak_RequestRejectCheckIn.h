...
#include "Hotel_Outbreak_RequestRejectCheckIn.generated.h"

UCLASS()
class BOOTS_ANKLE_HOTEL_API UHotel_Outbreak_RequestRejectCheckIn : public UHotel_OutbreakEventBase
{
	GENERATED_BODY()

public:
	UHotel_Outbreak_RequestRejectCheckIn();
